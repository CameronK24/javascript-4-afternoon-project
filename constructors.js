...
User.prototype.removeSavedPost = function(id) {
  let postToRemove = this.savedPosts.findIndex(e => e === id);
  return this.savedPosts.splice(postToRemove, 1);
}
...
User.prototype.changePostRating = function(id, newRating) {
  let postToUpdate = this.savedPosts.findIndex(e => e.id === id);
  this.savedPosts[postToUpdate].rating = newRating;
}
